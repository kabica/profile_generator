...
let paragraph = `${name} really enjoys to ${activity1} on the weeknds whilst listening to ${musicGenre}. While ${name} truly despises ${hatedFood}, 
				 ${name} loves to eat ${favFood}. If ${name} was stranded on a desert island and could only listen to one song, that thing would be ${song}.
				 In ${name}'s world, no superpower is more desirable than the ability to ${superPower}.`
...
// let printParagraph = function(name, activit1, musicGenre, hatedFood, favFood, song, superPower) {
// 	console.log(p
// } 
